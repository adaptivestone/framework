...
class WebSocket extends AbstractConnector{
    constructor(app){
        ...
        this.app = app;
        this.sockets = [];
        this.io = new Socketio(this.app.httpServer.httpServer,{'transports': ['websocket', 'polling']});
    ...
    async send(type,data,to = []){
        this.logger.info(`Send data type:'${type}' to '${to.join()}' data:'${JSON.stringify(data)}'`);
